        ...
        <div class="col-12 text-muted ">
            ...
            <div class=" text-center">
                <a class="btn btn-primary text-center"
                   href="{{ $system->redirect }}/authentication/unlock?token={{$data->token}}&username={{$data->user->username}}">
                    Desbloquear Usuario
                </a>
            </div>
            <br>
            ...
            <p class="text-muted">{{$system->redirect}}/authentication/unlock?token={{$data->token}}&username={{$data->user->username}}</p>
            <br>
