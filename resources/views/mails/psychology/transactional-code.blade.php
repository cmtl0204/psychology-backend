...
@section('content')
    <div class="row">
        <div class="col-12 text-muted">
            ...
            <p>
                Al ingresar el siguiente código de verificación, <b>usted confirma que acepta libre y voluntariamente
                    que su representado participe del servicio de tamizaje de salud mental.</b> También entiende que
                este procedimiento permite cuidar de los derechos de su representado/a, que su representado/a posterior
                al llenado de este servicio de tamizaje cuenta con la posibilidad de acceder a servicios de atención
            ...
            <br>
            <br>
            <p>Este código de verificación tiene tiempo de duración de
                <b>{{\App\Models\Authentication\User::DECAY_MINUTES_TRANSACTIONAL_CODE}} min.</b>
                10 min. y es válido por <b>una sola ocasión</b>.
            </p>
            <br>
